...
$misComidas = ["Hamberguer", "Calzon", "Filete Dorado"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pizza", "Sancocho", "Mofongo"]; // Reemplaza con las comidas favoritas de tu amigo
